...
gridCV = GridSearchCV(SVC(probability=True,class_weight='balanced'), parameters,scoring=make_scorer(f1_score, average='micro'))
classif = OneVsRestClassifier(gridCV)

classif.fit(X_train_tfidf, Y_train)

# f=open('/content/drive/My Drive/classifer_svc','rb')
...
classif.predict_proba(X_test_tfidf)
